    ...
    public ConfigM(JoinMessagePlus plugin, String name) {
	    ...
	    // Convert 3.0 config to 3.3
            if (tempcfg.contains("EnableJoinMessage")) {
                ...
                String JoinMessage = tempcfg.getString("JoinMessage").replace("%player", "%player_name%").replace("%displayname", "%player_displayname%");
                String QuitMessage = tempcfg.getString("QuitMessage").replace("%player", "%player_name%").replace("%displayname", "%player_displayname%");
